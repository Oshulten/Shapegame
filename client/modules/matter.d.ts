...
declare namespace Matter {
    ...
    export class Composite {
        ...
        static add(
            composite: Composite,
            object: Body | Composite | Constraint | MouseConstraint | Array<Body | Composite | Constraint | MouseConstraint>
        ): Composite;
    ...
    export class Plugin {
         ...
         */
        static use(module: { uses?: Array<Plugin | string> | undefined; [_: string]: any }, plugins: Array<Plugin | string>): void;
